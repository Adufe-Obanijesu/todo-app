...
const DeleteTodo = ({deleteTodoModal, setDeleteTodoModal, docRef }) => {
  ...
  return (
    ...
    ></div>
    <div className="bg-white shadow-lg w-2/6 p-3" style={{zIndex: 1000}}>
        <div className="border-b border-1 border-gray-200 py-2 mb-2">
        <h3 className="text-xl font-bold tracking-md">Are you sure you want to delete it</h3>
        </div>
        ...
        <div className="mt-4 flex justify-center">
            <div>
                ...
                <button
                type="button"
                className="mt-2 text-md bg-green-400 py-2 rounded-sm px-4 text-white hover:shadow hover:bg-green-500 transition ease-in duration-300 rounded" onClick={() => setDeleteTodoModal(false)}
                >No</button>
            </div>
        </div>
    </div>
