...
import { collection, db, onSnapshot, query, where, orderBy } from "../firebase/index";
...
const Homepage = () => {
  ...
  const ViewTodo = () => {
    ...
    if(todos.length === 0) return <h3 className="text-xl font-semibold text-white text-center">No plan found</h3>
    else return(
